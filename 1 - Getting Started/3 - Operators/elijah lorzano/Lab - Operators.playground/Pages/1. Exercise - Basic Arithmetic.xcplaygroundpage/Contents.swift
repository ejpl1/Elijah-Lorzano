...
print("This differs because using integer division to solve a problem that would normally give you a decimal, will just send the result to the nearest whole number, whereas doubles will give you an exact result.")
/*:
